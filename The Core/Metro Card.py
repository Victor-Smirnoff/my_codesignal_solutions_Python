...
# i.e. the number of days in February (note that leap years are not considered), and so on. The 13th time you extend the pass, you get 31 days again.
...
# An array of positive integers, the possible number of days for which you will extend your pass. 
# The elements of the array can only be equal to 28, 30 or 31 and must be sorted in increasing order.
